...
const all = [
  {
    ...
    handle: "marianacosta",
    role: "Plano familiar",
    text: "Agendei consulta e exame no mesmo dia, sem fila. Finalmente um plano que respeita o tempo da gente.",
  ...
  },
  {
    ...
    handle: "ricalmeida",
    role: "PME — 18 colaboradores",
    text: "A cotação empresarial foi direta e o time entendeu nossa operação. RH não vive mais perdido entre operadoras.",
  ...
  },
  {
    ...
    text: "Precisei de especialista com urgência e consegui em menos de 24h. Rede credenciada muito mais ampla do que esperava.",
  ...
  },
  {
    ...
    role: "PME — 9 colaboradores",
    text: "Melhor custo-benefício que encontrei para uma empresa pequena. Cobertura completa sem burocracia.",
  ...
  },
  {
    ...
    role: "Plano familiar",
    text: "Toda a família coberta, com acesso a especialistas de qualidade. Renovamos sem hesitar no segundo ano.",
  ...
  },
  {
    ...
    name: "Letícia Moura",
    handle: "leticiamoura",
    role: "Coletivo — Conselho Regional",
    text: "Filiada ao conselho profissional, consegui um plano excelente com desconto. Recomendo para todos os colegas.",
